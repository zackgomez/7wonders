...
describe('scoring tests', function () {
  ...
  it('should give no military tokens for tie', function () {
    expect(Scoring.getMilitaryTokensForAge(player, 1)).toEqual([]);
  ...
  it('should give correct tokens for wins and losses given age', function () {
    ...
    expect(Scoring.getMilitaryTokensForAge(player, 1)).toEqual([1, -1]);
    expect(Scoring.getMilitaryTokensForAge(player, 2)).toEqual([3, -1]);
    expect(Scoring.getMilitaryTokensForAge(player, 3)).toEqual([5, -1]);
  });
});
