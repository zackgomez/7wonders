...
var cards = [
  ...
  {age: 2, type: 'victory', name: 'Aqueduct', players: 3, resource_cost: ['S', 'S', 'S'], vps: 5},
  {age: 2, type: 'victory', name: 'Temple', players: 3, resource_cost: ['W', 'B', 'G'], vps: 3},
  {age: 2, type: 'victory', name: 'Statue', players: 3, resource_cost: ['W', 'O', 'O'], vps: 4},
  {age: 2, type: 'economy', name: 'Forum', players: 3, resource_cost: ['B', 'B'], resources: [['L', 'G', 'P']]},
  {age: 2, type: 'economy', name: 'Caravansery', players: 3, resource_cost: ['W', 'W'], resources: [['B', 'S', 'O', 'W']]},
  ...
  {age: 2, type: 'military', name: 'Stables', players: 3, resource_cost: ['O', 'B', 'W'], military: 2},
  {age: 2, type: 'military', name: 'Archery Range', players: 3, resource_cost: ['W', 'W', 'O'], military: 2},
  {age: 2, type: 'victory', name: 'Courthouse', players: 3, resource_cost: ['B', 'B', 'L'], vps: 4},
  {age: 2, type: 'science', name: 'Dispensary', players: 3, resource_cost: ['O', 'O', 'G'], science: 'C'},
  {age: 2, type: 'science', name: 'Laboratory', players: 3, resource_cost: ['B', 'B', 'P'], science: 'G'},
  {age: 2, type: 'science', name: 'Library', players: 3, resource_cost: ['S', 'S', 'L'], science: 'T'},
  ...
  {age: 2, type: 'science', name: 'Dispensary', players: 4, resource_cost: ['O', 'O', 'G'], science: 'C'},
  ...
  {age: 2, type: 'economy', name: 'Caravansery', players: 5, resource_cost: ['W', 'W'], resources: [['B', 'S', 'O', 'W']]},
  {age: 2, type: 'military', name: 'Stables', players: 5, resource_cost: ['O', 'B', 'W'], military: 2},
  {age: 2, type: 'victory', name: 'Courthouse', players: 5, resource_cost: ['B', 'B', 'L'], vps: 4},
  {age: 2, type: 'science', name: 'Laboratory', players: 5, resource_cost: ['B', 'B', 'P'], science: 'G'},
  ...
  {age: 2, type: 'victory', name: 'Temple', players: 6, resource_cost: ['W', 'B', 'G'], vps: 3},
  {age: 2, type: 'economy', name: 'Forum', players: 6, resource_cost: ['B', 'B'], resources: [['L', 'G', 'P']]},
  {age: 2, type: 'economy', name: 'Caravansery', players: 6, resource_cost: ['W', 'W'], resources: [['B', 'S', 'O', 'W']]},
  ...
  {age: 2, type: 'military', name: 'Archery Range', players: 6, resource_cost: ['W', 'W', 'O'], military: 2},
  {age: 2, type: 'science', name: 'Library', players: 6, resource_cost: ['S', 'S', 'L'], science: 'T'},
  {age: 2, type: 'victory', name: 'Aqueduct', players: 7, resource_cost: ['S', 'S', 'S'], vps: 5},
  {age: 2, type: 'victory', name: 'Statue', players: 7, resource_cost: ['W', 'O', 'O'], vps: 4},
  {age: 2, type: 'economy', name: 'Forum', players: 7, resource_cost: ['B', 'B'], resources: [['L', 'G', 'P']]},
  ...
  {age: 3, type: 'victory', name: 'Pantheon', players: 3, resource_cost: ['B', 'B', 'O', 'P', 'L', 'G'], vps: 7},
  {age: 3, type: 'victory', name: 'Gardens', players: 3, resource_cost: ['W', 'B', 'B'], vps: 5},
  ...
  {age: 3, type: 'military', name: 'Fortifications', players: 3, resource_cost: ['S', 'O', 'O', 'O'], military: 3},
  {age: 3, type: 'military', name: 'Arsenal', players: 3, resource_cost: ['O', 'W', 'W', 'L'], military: 3},
  {age: 3, type: 'military', name: 'Siege Workshop', players: 3, resource_cost: ['W', 'B', 'B', 'B'], military: 3},
  {age: 3, type: 'economy', name: 'Arena', players: 3, resource_cost: ['O', 'S', 'S']},
  {age: 3, type: 'victory', name: 'Senate', players: 3, resource_cost: ['O', 'S', 'W', 'W'], vps: 6},
  {age: 3, type: 'science', name: 'Lodge', players: 3, resource_cost: ['B', 'B', 'L', 'P'], science: 'C'},
  {age: 3, type: 'science', name: 'Observatory', players: 3, resource_cost: ['S', 'S', 'P', 'G'], science: 'G'},
  {age: 3, type: 'science', name: 'University', players: 3, resource_cost: ['W', 'W', 'P', 'G'], science: 'T'},
  {age: 3, type: 'science', name: 'Academy', players: 3, resource_cost: ['S', 'S', 'S', 'G'], science: 'C'},
  {age: 3, type: 'science', name: 'Study', players: 3, resource_cost: ['W', 'P', 'G'], science: 'G'},
  {age: 3, type: 'victory', name: 'Gardens', players: 4, resource_cost: ['W', 'B', 'B'], vps: 5},
  ...
  {age: 3, type: 'military', name: 'Circus', players: 4, resource_cost: ['S', 'S', 'S', 'O'], military: 3},
  {age: 3, type: 'military', name: 'Arsenal', players: 4, resource_cost: ['O', 'W', 'W', 'L'], military: 3},
  {age: 3, type: 'science', name: 'University', players: 4, resource_cost: ['W', 'W', 'P', 'G'], science: 'T'},
  {age: 3, type: 'victory', name: 'Townhall', players: 5, resource_cost: ['G', 'O', 'S', 'S'], vps: 6},
  {age: 3, type: 'military', name: 'Circus', players: 5, resource_cost: ['S', 'S', 'S', 'O'], military: 3},
  {age: 3, type: 'military', name: 'Siege Workshop', players: 5, resource_cost: ['W', 'B', 'B', 'B'], military: 3},
  {age: 3, type: 'economy', name: 'Arena', players: 5, resource_cost: ['O', 'S', 'S']},
  {age: 3, type: 'victory', name: 'Senate', players: 5, resource_cost: ['O', 'S', 'W', 'W'], vps: 6},
  {age: 3, type: 'science', name: 'Study', players: 5, resource_cost: ['W', 'P', 'G'], science: 'G'},
  {age: 3, type: 'victory', name: 'Pantheon', players: 6, resource_cost: ['B', 'B', 'O', 'P', 'L', 'G'], vps: 7},
  ...
  {age: 3, type: 'military', name: 'Circus', players: 6, resource_cost: ['S', 'S', 'S', 'O'], military: 3},
  {age: 3, type: 'science', name: 'Lodge', players: 6, resource_cost: ['B', 'B', 'L', 'P'], science: 'C'},
  {age: 3, type: 'victory', name: 'Palace', players: 7, vps: 8, resource_cost: ['G', 'P', 'L', 'B', 'W', 'O', 'S']},
  {age: 3, type: 'military', name: 'Fortifications', players: 7, resource_cost: ['S', 'O', 'O', 'O'], military: 3},
  {age: 3, type: 'military', name: 'Arsenal', players: 7, resource_cost: ['O', 'W', 'W', 'L'], military: 3},
  {age: 3, type: 'economy', name: 'Arena', players: 7, resource_cost: ['O', 'S', 'S']},
  {age: 3, type: 'science', name: 'Observatory', players: 7, resource_cost: ['S', 'S', 'P', 'G'], science: 'G'},
  {age: 3, type: 'science', name: 'Academy', players: 7, resource_cost: ['S', 'S', 'S', 'G'], science: 'C'},
